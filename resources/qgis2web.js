...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 15, minZoom: 11, projection: new ol.proj.Projection({
            code: 'EPSG:2056',
            //extent: [670693.125000, 154756.890625, 2679790.043200, 1204075.563000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([2531908.818087, 1081197.396040, 2674148.818087, 1173828.021040], map.getSize());
