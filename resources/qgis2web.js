...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 15, minZoom: 11, projection: new ol.proj.Projection({
            code: 'EPSG:2056',
            //extent: [2548583.015543, 1078574.695590, 2679790.043200, 1167428.709780],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([2552501.494520, 1085867.348243, 2663758.786187, 1162993.389910], map.getSize());
