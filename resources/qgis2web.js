...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 15, minZoom: 11, projection: new ol.proj.Projection({
            code: 'EPSG:2056',
            //extent: [670693.125000, 154756.890625, 2679790.043200, 1261470.000000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([2596696.307562, 1112421.394733, 2667101.932562, 1148854.519733], map.getSize());
