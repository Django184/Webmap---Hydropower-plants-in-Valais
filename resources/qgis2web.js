...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 15, minZoom: 11, projection: new ol.proj.Projection({
            code: 'EPSG:2056',
            //extent: [670693.125000, 154756.890625, 2679790.043200, 1167428.709780],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([2552075.192015, 1113603.280793, 2624802.653492, 1132099.065443], map.getSize());
