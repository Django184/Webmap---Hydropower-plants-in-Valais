...
var lyr__11 = new ol.layer.Vector({
                ...
                popuplayertitle: '',
                interactive: false,
                title: '<img src="styles/legend/_11.png" /> '
            });
var format_Lots_12 = new ol.format.GeoJSON();
var features_Lots_12 = format_Lots_12.readFeatures(json_Lots_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2056'});
var jsonSource_Lots_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Lots_12.addFeatures(features_Lots_12);
var lyr_Lots_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Lots_12, 
                style: style_Lots_12,
                popuplayertitle: 'Lots',
                interactive: false,
                title: '<img src="styles/legend/Lots_12.png" /> Lots'
            });
var format_Cities_13 = new ol.format.GeoJSON();
var features_Cities_13 = format_Cities_13.readFeatures(json_Cities_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:2056'});
var jsonSource_Cities_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Cities_13.addFeatures(features_Cities_13);
var lyr_Cities_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Cities_13, 
                style: style_Cities_13,
                popuplayertitle: 'Cities',
                interactive: false,
                title: '<img src="styles/legend/Cities_13.png" /> Cities'
            });
var group_Projects = new ol.layer.Group({
                                layers: [lyr__11,lyr_Lots_12,],
                                fold: 'close',
                                title: 'Projects'});
...
var group_Hydrology = new ol.layer.Group({
                                layers: [lyr_BassinversantduRhne_4,lyr_Rivers_5,lyr_Hydrologicalfunctions_6,],
                                fold: 'close',
                                title: 'Hydrology'});
...
lyr_Valais_0.setVisible(true);lyr_Vaud_1.setVisible(true);lyr_Valais_2.setVisible(true);lyr_Vaud_3.setVisible(true);lyr_BassinversantduRhne_4.setVisible(true);lyr_Rivers_5.setVisible(true);lyr_Hydrologicalfunctions_6.setVisible(true);lyr_Links_7.setVisible(true);lyr_Outlets_8.setVisible(true);lyr_NotincludedinRhnehydropeaking_9.setVisible(true);lyr_IncludedinRhnehydropeaking_10.setVisible(true);lyr__11.setVisible(true);lyr_Lots_12.setVisible(true);lyr_Cities_13.setVisible(true);
var layersList = [group_Administrativeboundaries,group_Topography,group_Hydrology,group_Hydropowerplants,group_Projects,lyr_Cities_13];
...
lyr_Lots_12.set('fieldAliases', {'id': 'id', 'Name': 'Name', });
lyr_Cities_13.set('fieldAliases', {'fid': 'fid', 'Town': 'Town', 'Lat': 'Lat', 'Long': 'Long', });
...
lyr__11.set('fieldImages', {'id': '', });
lyr_Lots_12.set('fieldImages', {'id': '', 'Name': '', });
lyr_Cities_13.set('fieldImages', {'fid': 'TextEdit', 'Town': 'TextEdit', 'Lat': 'TextEdit', 'Long': 'TextEdit', });
...
lyr__11.set('fieldLabels', {'id': 'no label', });
lyr_Lots_12.set('fieldLabels', {'id': 'no label', 'Name': 'no label', });
lyr_Cities_13.set('fieldLabels', {'fid': 'hidden field', 'Town': 'hidden field', 'Lat': 'no label', 'Long': 'no label', });
lyr_Cities_13.on('precompose', function(evt) {
